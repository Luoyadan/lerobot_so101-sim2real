...
class SO101GraspCubeDomainRandomizationConfig:
    ...
    cube_half_size_range: Sequence[float] = (0.03 / 2, 0.05 / 2)
    cube_friction_mean: float = 0.06
    cube_friction_std: float = 0.05
    cube_friction_bounds: Sequence[float] = (0.01, 0.2)
...
class SO101GraspCubeEnv(BaseDigitalTwinEnv):
    ...
    **Success Conditions:**
    ...
    def __init__(
        ...
        *args,
        ...
        domain_randomization_config: Union[
            SO101GraspCubeDomainRandomizationConfig, dict
        ...
        **kwargs,
        ...
        self.domain_randomization_config = SO101GraspCubeDomainRandomizationConfig()
        ...
        if isinstance(domain_randomization_config, dict):
            ...
            self.domain_randomization_config = dacite.from_dict(
                data_class=SO101GraspCubeDomainRandomizationConfig,
    ...
    def _get_obs_agent(self):
        ...
        # SO101 arm qvel are likely too noisy to learn from and not implemented.
